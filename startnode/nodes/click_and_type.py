...
from startnode.models.actions import Actions
from startnode.factories.node_factory import NodeFactory
from startnode.services.web_automation import WebAutomationService
from startnode.agents.typing_agent import TypingAgent
from startnode.utils.exceptions.element_not_found_exception import ElementNotFoundException
from startnode.utils.helpers.cleanup_helper import CleanupHelper
from startnode.services.bounding_box import BoundingBoxService
from startnode.utils.screenshot_generator import ScreenshotGenerator
...
class ClickableAndTypeableNode(Node):
    ...
    def run(self, startnode_object, steps, history, objective, web_automater, db_session, s3_client,
