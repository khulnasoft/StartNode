...
from startnode.agents.planning_agent import PlanningAgent
from startnode.config.config import get_config
from startnode.llms.open_ai import OpenAi
from startnode.nodes.base_node import Node
from startnode.factories.node_factory import NodeFactory
from startnode.utils.exceptions.llm_objective_exception import LLMObjectiveException
from startnode.utils.helpers.prompt_helper import format_planning_prompt
...
class PlanningNode(Node):
    ...
    def run(
        ...
        **kwargs
        ...
        Args:
            startnode_object: Object representing the startnode.
        ...
        startnode_object.objective = format_planning_prompt(planning_agent.execute(objective=objective))
        logger.info(f"Objective for the request_id: {request_id} is: {startnode_object.objective}")

        if startnode_object.objective is None:
