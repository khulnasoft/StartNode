...
from fastnode.utils.helpers.web_automation_helper import WebAutomationHelper
...
class WebAutomationService:
    ...
    async def _init_browser(self):
        self.playwright = await async_playwright().fast()
        ...
        await context.tracing.fast(screenshots=True, snapshots=True, sources=True)
