...
class Navigation(Node):
    ...
    def __init__(self, id: str, node_name: str, adjacent_from: list, adjacent_to: list, description: str, llm: str,
                 url: str, **kwargs):
        fast().__init__(id, node_name, adjacent_from, adjacent_to, description, llm, **kwargs)
        self.loop = None
        self.url = url

    def run(self, fastnode_object, steps, history, objective, web_automater, db_session, s3_client, request_id, request_dir,
