...
from fastnode.services.web_automation import WebAutomationService
from fastnode.agents.typing_agent import TypingAgent
from fastnode.utils.exceptions.element_not_found_exception import ElementNotFoundException
from fastnode.utils.helpers.cleanup_helper import CleanupHelper
from fastnode.services.bounding_box import BoundingBoxService
...
class ClickableAndTypeableNode(Node):
    ...
    def __init__(self, id: str, node_name: str, adjacent_from: list, adjacent_to: list,
        ...
        fast().__init__(id, node_name, adjacent_from, adjacent_to, description, llm)
        self.loop = None
    ...
    def run(self, fastnode_object, steps, history, objective, web_automater, db_session, s3_client,
